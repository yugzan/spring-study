    ...
    public void slackMessagePostedEventContent(SlackSession session)
    {
        session.addMessagePostedListener(new SlackMessagePostedListener()
        {
            ...
            public void onEvent(SlackMessagePosted event, SlackSession session1)
            {
                ...
                SlackChannel theChannel = session1.findChannelByName("general");
...
//                SlackUser myInterestingUser = session1.findUserByUserName("yugzan");
//
...
//                }
                ...
                session1.sendMessage(event.getChannel(),"Oh My God");
            }
        });
    }
